  ...
  const [receptii, setReceptii] = useState<ReceptieMaterial[]>([
    {
      ...
      observatii: "Recepție nisip natural"
    },
    {
      id: 2,
      data: "26/11/2024",
    ...
    },
    {
      ...
      data: "25/11/2024",
      cod: "8/16 CONC",
      furnizor: "Agregate Construct SA",
      material: "8/16 CONC",
      nr_aviz_provizoriu: "AP-003",
      nr_aviz_intrare: "AI-003",
      nr_factura: "F-2024-003",
      nr_tichet: "T-003",
      nume_sofer: "Gheorghe Ionescu",
      nr_inmatriculare: "IF-55-DEF",
      tip_masina: "Articulata",
      cantitate_livrata: 40,
      cantitate_receptionata: 40,
      diferenta: 0,
      pret_material_total: 18200,
      pret_total: 19000,
      pret_transport_total: 800,
      observatii: "Pietriș concasat 8/16"
    },
    {
      id: 4,
      data: "24/11/2024",
      cod: "FILLER",
      furnizor: "Ciment Holding SRL",
      material: "FILLER",
      nr_aviz_provizoriu: "AP-004",
      nr_aviz_intrare: "AI-004",
      nr_factura: "F-2024-004",
      nr_tichet: "T-004",
      nume_sofer: "Andrei Dumitrescu",
      nr_inmatriculare: "B-456-GHI",
      tip_masina: "4X2",
      cantitate_livrata: 12,
      cantitate_receptionata: 11.9,
      diferenta: 0.1,
      pret_material_total: 6500,
      pret_total: 6900,
      pret_transport_total: 400,
      observatii: "Filler calcaros"
    },
    {
      id: 5,
      data: "23/11/2024",
      cod: "4/8 CRIBLURI",
      furnizor: "Cariera Glina SA",
      material: "4/8 CRIBLURI",
      nr_aviz_provizoriu: "AP-005",
      nr_aviz_intrare: "AI-005",
      nr_factura: "F-2024-005",
      nr_tichet: "T-005",
      nume_sofer: "Mihai Stanescu",
      nr_inmatriculare: "GR-12-JKL",
      tip_masina: "8X4",
      cantitate_livrata: 30,
      cantitate_receptionata: 29.7,
      diferenta: 0.3,
      pret_material_total: 13500,
      pret_total: 14200,
      pret_transport_total: 700,
      observatii: "Cribluri 4/8mm"
    },
    {
      id: 6,
      data: "22/11/2024",
      cod: "MOTORINA",
      furnizor: "Petrom Distribution",
      material: "MOTORINA",
      nr_aviz_provizoriu: "AP-006",
      nr_aviz_intrare: "AI-006",
      nr_factura: "F-2024-006",
      nr_tichet: "T-006",
      nume_sofer: "Constantin Radu",
      nr_inmatriculare: "B-789-MNO",
      tip_masina: "Articulata",
      cantitate_livrata: 35,
      cantitate_receptionata: 35,
      diferenta: 0,
      pret_material_total: 52500,
      pret_total: 53200,
      pret_transport_total: 700,
      observatii: "Motorină pentru utilaje"
    }
  ]);
