  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Adaugă Client</h1>
          <p className="text-muted-foreground mt-2">
            Completați formularul pentru a adăuga un client nou
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Introduceți informațiile despre clientul nou
          </CardDescription>
        </CardHeader>
        <CardContent>
