...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List 
    ref={ref} 
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-muted/60 p-1.5 text-muted-foreground gap-1",
      "backdrop-blur-sm border border-border/30 shadow-inner",
      className
    )} 
    {...props} 
  />
