  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "gap-4 border border-border/30 bg-background/95 p-6 shadow-2xl rounded-2xl",
        "backdrop-blur-xl",
    ...
    >
      {children}
      {!hideCloseButton && (
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-2 opacity-60 ring-offset-background transition-all duration-300 hover:opacity-100 hover:bg-muted/80 hover:rotate-90 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none">
          <X className="h-4 w-4" />
